...
<ul>
  ...
  <li><font size=3>“Deadline Differentiated Dynamic EV Charging Price Menu Design”<font size=3>  <br>
    ...
    <font size=2>Accepted by the 22th Power Systems Computation Conference (<b>PSCC 2022</b>) and <b>Electric Power Systems Research</b>. (JCR Q2)<font size=2><a href="[复制的IEEE链接](https://ieeexplore.ieee.org/document/10251453)">Link</a>
    ...
    <font size=2>Accepted by the 60th IEEE Conference on Decision and Control (<b>CDC '21</b>).</font><a href="[复制的IEEE链接](https://ieeexplore.ieee.org/document/10251453)">Link</a>
