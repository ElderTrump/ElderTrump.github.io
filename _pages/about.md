...
<ul>
  ...
  <li><font size=3>“High-Resolution Probabilistic Load Forecasting: A Learning Ensemble Approach”<font size=3>  <br>
    ...
    <font size=2>Accepted by <b>The Journal of the Franklin Institute</b>. (JCR Q1)<font size=2>.</li>
  ...
  <li><font size=3>“Deadline Differentiated Dynamic EV Charging Price Menu Design”<font size=3>  <br>
    ...
    <font size=2>Accepted by <b>IEEE Transactions on Network Science and Engineering</b>. (JCR Q1)<font size=2></li>
    ...
    <font size=2>Accepted by <b>IEEE Systems Journal</b>. (JCR Q1)<font size=2></li>
    ...
    <font size=2>Accepted by the 22th Power Systems Computation Conference (<b>PSCC 2022</b>) and <b>Electric Power Systems Research</b>. (JCR Q2)<font size=2></li>
    ...
    <font size=2>Accepted by the 29th ACM SIGSPATIAL International Conference on Advances in Geographic Information Systems (<b>ACM SIGSPATIAL 2021</b>) as a full paper in research track (<b>Acceptance Rate 22.4%</b>).<font size=2></li>
    ...
    <font size=2>Accepted by the 60th IEEE Conference on Decision and Control (<b>CDC '21</b>).<font size=2></li>
    ...
    <font size=2>Accepted by the 2021 ACM International Joint Conference on Pervasive and Ubiquitous Computing (<b>UbiComp '21</b>) as a workshop paper.</font></li>
    ...
    <font size=2>Accepted by <b>IEEE Transactions on Smart Grid</b>. (JCR Q1)</font></li>
</ul>
